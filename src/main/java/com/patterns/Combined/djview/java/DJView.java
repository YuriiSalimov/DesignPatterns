...
public final class DJView implements ActionListener, BeatObserver, BPMObserver {
    ...
    public void createView() {
        ...
        this.viewFrame.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
    ...
    public void createControls() {
        ...
        this.startMenuItem.addActionListener(event -> controller.start());
        this.stopMenuItem = new JMenuItem("Stop");
        this.menu.add(this.stopMenuItem);
        this.stopMenuItem.addActionListener(event -> controller.stop());
    ...
    public void updateBPM() {
        if (this.model != null) {
            ...
            if (bpm == 0) {
                ...
                if (this.bpmOutputLabel != null) {
                    this.bpmOutputLabel.setText("Current BPM: " + model.getBPM());
                }
            }
        }
    }
